...
if (isset($_GET['product_id'])) {
    ...
    $imgpath = SITE_URL . 'PHPOPS/eCommerce/assets/image/productUpload/' . $_GET['product_id'] . '/' . $result[0]['image'];
        ...
        if ($_FILES['productImage']['size'] > 0) {
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png"|| $fileExtension == "webp") {
                if ($fileSize >= 0 && $fileSize <= 5000000) {
                    ...
                    if ($result == true) {
                        $uploadDirectory = '/var/www/html/ops/public_html/PHPOPS/eCommerce/assets/image/productUpload/' . $_GET['product_id'] . '/';
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png"|| $fileExtension == "webp") {
                if ($fileSize >= 0 && $fileSize <= 5000000) {
                    ...
                    if ($result == 'error') {
                        ...
                        $uploadDirectory = '/var/www/html/ops/public_html/PHPOPS/eCommerce/assets/image/productUpload/' . $result . '/';
                        if (!file_exists($uploadDirectory)) {
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-center mb-3">
                            ...
                            if (isset($_GET['product_id'])) {
                                ...
                                echo ' <img src="' . SITE_URL . 'PHPOPS/eCommerce/assets/image/gift.png" id="productpreimage" alt="..." class="img-fluid rounded-start w-50" alt="...">';
                            }
                            ?>
                        </div>
