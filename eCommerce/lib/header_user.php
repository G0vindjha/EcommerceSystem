            ...
            <div class="modal-header">
                <div class="d-flex justify-content-center py-4">
                    <div class="logo d-flex align-items-center w-auto justify-content-center">
                        <img class="mx-auto" src="<?php echo SITE_URL; ?>PHPOPS/eCommerce/assets/image/Logo.png" alt="">
                    </div>
                </div>
                                        ...
                                        <form class="row g-3 needs-validation" novalidate method="post">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <a href="<?php echo SITE_URL;?>PHPOPS/eCommerce/userRagistration.php">Create Account</a>
