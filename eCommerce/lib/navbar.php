    ...
    <div class="row gy-3 mt-3 my-auto ">
        <div class="col-lg-2 col-sm-4 col-4 d-flex justify-content-start">
            <a href="index.php" class="float-start">
                <img src="<?php echo SITE_URL;?>PHPOPS/eCommerce/assets/image/Logo.png" class="w-100">
            </a>
        </div>
        <div class="order-lg-last col-lg-7 col-sm-8 col-8 my-auto">
            <div class="d-flex float-end">
                ...
                <div class="nav-item dropdown pe-3 gap-2" id="nav">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo SITE_URL;?>PHPOPS/eCommerce/customer_profile.php">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo SITE_URL;?>PHPOPS/eCommerce/orderList.php">
            ...
            <a href="<?php echo SITE_URL;?>PHPOPS/eCommerce/cart.php" class="btn btn1 text-white border rounded py-1 px-3 nav-link d-flex align-items-center"> <i class="fas fa-shopping-cart m-1 me-md-2"></i>
...
<nav class="navbar navbar1 navbar-expand-lg navbar-dark  mt-2 d-lg-block collapse navbar-collapse" id="navbarLeftAlignExample">
    <div class="container justify-content-center justify-content-md-between">
        <div>
            ...
            <li class="nav-item">
                       <a class="nav-link" href="<?php echo SITE_URL;?>PHPOPS/eCommerce/index.php">Home</a>
                   </li>
                <?php 
                    $conn = new Connection();
