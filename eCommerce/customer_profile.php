        ...
        if ($_FILES['image']['name'] != '') {
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png") {
                if ($fileSize >= 0 && $fileSize <= 1000000) {
                    ...
                    if ($result == 1) {
                        $uploadDirectory = '/var/www/html/ops/public_html/PHPOPS/eCommerce/assets/image/customerUpload/' . $_SESSION['customer_id'] . '/';
...
$leftProfile = "<div class='card'>
                <div class='card-body profile-card pt-4 d-flex flex-column align-items-center'>
                    <img src='" . SITE_URL . "PHPOPS/eCommerce/assets/image/customerUpload/" . $result[0]['customer_id'] . "/" . $result[0]['image'] . "' alt='Profile' class='rounded-circle w-50'>
