...
<header id="header" class="header fixed-top d-flex align-items-center z-9999" style="background-color:lightblue;">
  ...
  <div class="col-2 d-none d-md-block">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/dashboard.php" class="logo d-flex align-items-center">
        <img src="<?php echo SITE_URL; ?>PHPOPS/eCommerce/assets/image/companyIcon.png" alt="...">
  ...
  <div class="col-12 col-md-2">
    <aside id="sidebar" class="collapse d-md-block fixed-top  bg-white z-9999 mt-5" style="width:min-content; margin-top: 60px !important;">
      <ul class="sidebar-nav" id="sidebar-nav" style="width: max-content;margin: revert;">
        <li class="nav-item">
          <a class="nav-link " href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/dashboard.php">
                ...
                <div id="CustomerAccordionCollapse" class="accordion-collapse collapse" aria-labelledby="CustomerAccordionFlush" data-bs-parent="#CustomerAccordion">
                  <div class="accordion-body">
                    <ul class="p-0" style="width: max-content;">
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/customerList.php">List Customer</a></li>
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/addCustomer.php">Add New Customer</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion accordion-flush nav-link p-0" id="productAccordion">
              <div class="accordion-item px-3">
                ...
                <div id="ProductAccordionCollapse" class="accordion-collapse collapse" aria-labelledby="productAccordionFlush" data-bs-parent="#productAccordion">
                  <div class="accordion-body">
                    <ul class="p-0" style="width: max-content;">
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/productList.php">List Product</a></li>
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/addProduct.php">Add New Product</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion accordion-flush nav-link p-0" id="CategoryAccordion">
              <div class="accordion-item px-3">
                ...
                <div id="CategoryAccordionCollapse" class="accordion-collapse collapse" aria-labelledby="CategoryAccordionFlush" data-bs-parent="#CategoryAccordion">
                  <div class="accordion-body">
                    <ul class="p-0" style="width: max-content;">
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/categories.php">List Categories</a></li>
                      <li class="nav-item"><a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/addCategories.php">Add New Category</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL;?>PHPOPS/eCommerce/admin/orderlist.php">
          <i class="bi bi-clipboard-check-fill"></i>
            <span>Order List</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link collapsed f-flex gap-1" href="<?php echo SITE_URL;?>PHPOPS/eCommerce/admin/faq.php">
            ...
            <div class="modal-header">
                <div class="d-flex justify-content-center py-4">
                    <div class="logo d-flex align-items-center w-auto">
                        <img src="<?php echo SITE_URL; ?>PHPOPS/eCommerce/assets/image/Logo.png" alt="...">
                    </div>
                </div>
