...
if ($_POST['action'] == 'searchData') {
    ...
    $new = array_filter($result, function ($value) use ($search, &$srno) {
        ...
        <div class='col'><a href='" . SITE_URL . "PHPOPS/eCommerce/admin/addCategories.php?category_id="  . $value['category_id'] . "' type='button' id='udp"  . $value['category_id'] . "' class='udp btn btn-success upd'>UPDATE</a></div>
        ...
        <main class='position-relative my-3'>
            <div class="row d-flex justify-content-between mb-3">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <a class="btn btn-outline-success" href="<?php echo SITE_URL; ?>PHPOPS/eCommerce/admin/addCategories.php" role="button">Add New Category</a>
                </div>
                <!-- Category table -->
