...
foreach ($Products as $Productsvalue) {
    $imgpath = SITE_URL . 'PHPOPS/eCommerce/assets/image/productUpload/' . $Productsvalue['product_id'] . '/' . $Productsvalue['image'];
...
foreach ($Customers as $Customersvalue) {
    $customerImgpath = SITE_URL . 'PHPOPS/eCommerce/assets/image/customerUpload/' . $Customersvalue['customer_id'] . '/' . $Customersvalue['image'];
...
foreach ($result as $value) {
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2">
                <img src="' . SITE_URL . 'PHPOPS/eCommerce/assets/image/productUpload/' . $value["product_id"] . '/' . $value["image"] . '" class="img-fluid" alt="Phone">
            </div>
    ...
    <div class="row d-flex justify-content-center p-0 m-0 mt-3">
        <div class="col-11 d-flex align-items-center border border-secondary shadow mb-5 bg-body rounded">
            ...
            <div class="col-6 align-self-end text-end">
                <img src="<?php echo SITE_URL; ?>PHPOPS/Day19/Assignments/Project1/admin/assets/img/customer-support.png" alt="Customer Support" class="img-fluid illustration-img">
            </div>
        </div>
    </div>
    <section>
