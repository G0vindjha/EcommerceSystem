...
if (isset($_GET['customer_id'])) {
    ...
    $imgpath = SITE_URL . 'PHPOPS/eCommerce/assets/image/customerUpload/' . $_GET['customer_id'] . '/' . $updateResult['image'];
        ...
        if ($_FILES['profile_Pic']['size']) {
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png") {
                if ($fileSize >= 0 && $fileSize <= 1000000) {
                    ...
                    if ($result == true) {
                        $uploadDirectory = '/var/www/html/ops/public_html/PHPOPS/eCommerce/assets/image/customerUpload/' . $_GET['customer_id'] . '/';
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png") {
                if ($fileSize >= 0 && $fileSize <= 1000000) {
                    ...
                    if ($result == 'error') {
                        ...
                        $uploadDirectory = '/var/www/html/ops/public_html/PHPOPS/eCommerce/assets/image/customerUpload/' . $result . '/';
                        if (!file_exists($uploadDirectory)) {
    ...
    <div class="container-fluid mt-3 border border-primary border-3 p-3 rounded">
        ...
        <div class="d-flex justify-content-center mb-3">
            ...
            if (isset($_GET['customer_id'])) {
                ...
                echo ' <img src="'.SITE_URL.'PHPOPS/eCommerce/assets/image/userlogo.svg" id="userlogo" alt="..." class="rounded" width="130px">';
            }
            ?>
        </div>
        <!-- User from start -->
