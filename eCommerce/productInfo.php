...
if (!isset($_GET['product_id'])) {
    ...
    $productImg =  '<img style="max-width: 100%; margin: auto;" class=" rounded-4 fit" src="' . SITE_URL . 'PHPOPS/eCommerce/assets/image/productUpload/' . $result[0]["product_id"] . '/' . $result[0]["image"] . '">';
